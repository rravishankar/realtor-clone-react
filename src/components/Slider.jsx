...
export default function Slider() {
  ...
  return (
    listings && (<>
      <Swiper slidesPerView={1} navigation pagination={{type:"progressbar"}} effects="fade" modules={[EffectFade]} autoplay={{delay:3000}}>
      {listings.map(({data,id})=> (
        <SwiperSlide key={id} onClick={()=>navigate(`/category/${data.type}/${id}`)}>
            ...
            <p className='text-[#f1faee] absolute left-1 bottom-1 font-bold max-w-[90%] bg-[#e63946] shadow-lg opacity-90 p-2 rounded-tr-3xl'>
