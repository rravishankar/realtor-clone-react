...
import { useEffect } from 'react';
 ...
 export default function CreateListing() {
    ...
    async function onSubmit(e) {
        ...
        if (images.length > 6) {
            setLoading(false)
            toast.error("Max images allowed are 6")
            return;
        }
        let geolocation = {};
        let location
    ...
    <main className='max-w-md px-2 mx-auto'>
        ...
        <form onSubmit={onSubmit}>
            ...
            <div className='flex'>
                ...
                <button type="button" id="type" value="rent" onClick={onChange} className={`ml-3 px-7 py-3 font-medium text-sm uppercase shadow-md rounded hover:shadow-lg focus:shadow-lg active:shadow-lg transition duration-150 ease-in-out w-full ${
            ...
            <div className='flex space-x-7 justify-start mb-6'>
                <div className=''>
            ...
            {!geolocationEnabled && (
                <div className="flex space-x-6 justify-start mb-6">
                    <div className="div">
                        ...
                        <input type="number" id="latitude" value={latitude} onChange={onChange} required min="-90" max="90" className='w-full px-4 py-2 text-xl text-gray-700 bg-white border border-gray-300 rounded transition duration-150 ease-in-out focus:bg-white focus:text-gray-700 focus:border-l-slate-600 text-center'/>
                    </div>
                    <div className="div">
                        <p className='text-lg font-semibold'>Longitude</p>
                        <input type="number" id="longitude" value={longitude} onChange={onChange} required min="-180" max="180" className='w-full px-4 py-2 text-xl text-gray-700 bg-white border border-gray-300 rounded transition duration-150 ease-in-out focus:bg-white focus:text-gray-700 focus:border-l-slate-600 text-center'/>
                    </div>
                </div>
            )}
            ...
            <div className='flex items-center mb-6'>
                <div className=''>
                    ...
                    <input type="number" id="regularPrice" value={regularPrice} onChange={onChange} min="50" max="400000000" required className='w-full px-4 py-2 text-xl text-gray-700 bg-white border border-gray-300 rounded transition duration-150 ease-in-out focus:text-gray-700 focus:bg-white focus:border-slate-600 text-center'></input>
                    {type === "rent" && (
                        <div className=''> 
            ...
            <div className='mb-6'>
                ...
                <input type="file" id="images" onChange={onChange} accept=".jpg,.png,.jpeg" multiple required className='w-full px-3 py-1.5 text-gray-700 border border-gray-300 rounded transition duration-150 ease-in-out focus:bg-white focus:border-slate-600'/>
